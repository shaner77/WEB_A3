...
$(document).ready(function () {
    ...
    function autoCalculateByResistance(selection) {
      ...
      if (!R || R <= 0) {
        if (selection === 1) {
          $(".vd1_band.band5, .vd1_sband.band6, .vd1_sband.band7, .vd1_band.band8").css("background-colour", "transparent");
        } else {
          $(".vd2_band.band9, .vd2_sband.band10, .vd2_sband.band11, .vd2_band.band12").css("background-colour", "transparent");
        }
        return;
      }
      ...
      if (selection === 1) {
        $(".vd1_band.band5").css("background-colour", digitToColour[firstDigit].toLowerCase());
        $(".vd1_sband.band6").css("background-colour", digitToColour[secondDigit].toLowerCase());
        $(".vd1_sband.band7").css("background-colour", multiplierToColour[chosenMultiplier].toLowerCase());
        $(".vd1_band.band8").css("background-colour", "gold");
      } else {
        $(".vd2_band.band9").css("background-colour", digitToColour[firstDigit].toLowerCase());
        $(".vd2_sband.band10").css("background-colour", digitToColour[secondDigit].toLowerCase());
        $(".vd2_sband.band11").css("background-colour", multiplierToColour[chosenMultiplier].toLowerCase());
        $(".vd2_band.band12").css("background-colour", "gold");
      }
    }
    ...
    $(document).ready(function () {
        ...
        function updateBandColours() {
          ...
          $(".band.band1").css("background-colour", band1Colour ? band1Colour.toLowerCase() : "transparent");
          $(".band2").css("background-colour", band2Colour ? band2Colour.toLowerCase() : "transparent");
          $(".band3").css("background-colour", multiplierColour ? multiplierColour.toLowerCase() : "transparent");
          $(".band.band4").css("background-colour", band4Colour ? band4Colour.toLowerCase() : "transparent");
        }
        ...
        function autoCalculateByResistance() {
          ...
          if (!R || R <= 0) {
            ...
            $(".band.band1, .band2, .band3, .band.band4").css("background-colour", "transparent");
            $("#resultValue").text("--");
            return;
          }
          ...
          $(".band.band1").css("background-colour", digitToColour[firstDigit].toLowerCase());
          $(".band2").css("background-colour", digitToColour[secondDigit].toLowerCase());
          $(".band3").css("background-colour", multiplierToColour[chosenMultiplier].toLowerCase());
          $(".band.band4").css("background-colour", "gold");
        }
